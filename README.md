...
- The public website is live on GitHub Pages at `https://mysticalg.github.io/AI-Workspace-Archive-Pad/`.
- The public privacy URL is `https://mysticalg.github.io/AI-Workspace-Archive-Pad/privacy.html`.
- The public support URL is `https://mysticalg.github.io/AI-Workspace-Archive-Pad/support.html`.
- Website changes under `website/` now redeploy automatically via `.github/workflows/deploy-website.yml`, and the workflow can still be run manually from GitHub Actions when needed.
